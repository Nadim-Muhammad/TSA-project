...
Second:
1-12 initial shock in impact for second up to 12 period, since then the impact stays stable at around 0,05.
...
```
The results are pretty similar to the earlier `VAR(6)` model with only difference being slightly decreased level of impact in first making it slightly below zero and higher result in second leaving it slightly above 0,05.
